...
$tute_qury=mysqli_query($conn,"SELECT * FROM lmsclasstute WHERE subject IN ($sub_array_join) and ctype='Paper Class' and status='1' and add_date BETWEEN '$s_month' and '$e_month' and subject='$fsubject'");
...
$tute_qury=mysqli_query($conn,"SELECT * FROM lmsclasstute WHERE subject IN ($sub_array_join) and ctype='Paper Class' and status='1'");
while($tute_resalt=mysqli_fetch_array($tute_qury)){
