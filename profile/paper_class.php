...
$lavel_qury=mysqli_query($conn,"SELECT * FROM lmsclass_schlmsle WHERE subject IN ($sub_array_join) and classtype='Paper Class' and classstatus='1' and add_date BETWEEN '$s_month' and '$e_month' and subject='$fsubject'");
...
$lavel_qury=mysqli_query($conn,"SELECT * FROM lmsclass_schlmsle WHERE subject IN ($sub_array_join) and classtype='Paper Class' and classstatus='1'");
while($level_resalt=mysqli_fetch_array($lavel_qury)){
